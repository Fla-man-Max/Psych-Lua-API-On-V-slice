...
import psychlua.LuaScriptManager;
#end
#if mobile
...
class PlayState extends MusicBeatSubState
{
  ...
  #if FEATURE_PSYCH_LUA
  var psychLua:Null<LuaScriptManager>;
  #end
  ...
  override public function create():Void
  {
    ...
    #if FEATURE_PSYCH_LUA
    psychLua = LuaScriptManager.loadGameplayScriptsForState(this);
    psychLua?.callHook('onCreate', []);
    #end
    ...
    #if FEATURE_PSYCH_LUA
    psychLua?.callHook('onCreatePost', []);
    #end
  }
